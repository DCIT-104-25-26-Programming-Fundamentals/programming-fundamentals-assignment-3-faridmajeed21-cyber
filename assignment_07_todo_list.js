...
/**
 * FEATURE 2: Displays all tasks currently in the array.
 */
function viewTasks() {
  if (tasks.length === 0) {
...
/**
 * FEATURE 3: Deletes a task selected by the user.
 */
function deleteTask() {
  if (tasks.length === 0) {
  ...
  const index = taskNum - 1; // Convert 1-based display number to 0-based array index
